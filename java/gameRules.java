...
public class gameRules {
    ...
    public gameRules() {
        ...
        + "\n"
        + "6b.   Exit forts: The defenders also win if the king has contact with the board edge, is able to move, and it is impossible for the attackers to capture him after any amount of moves.\n"
        + "  Exit forts. \n"
        + "\n"
        ...
        + "\n"
        + "8a.   Perpetual repetitions are forbidden. A player who maintains a board repetition (\"the aggressive player\") must find another move to break the repetition, or he loses the game.\n"
